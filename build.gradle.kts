...
plugins {
    kotlin("jvm").version(version = System.getProperty("kotlin_version"))
    id("fabric-loom").version(version = System.getProperty("loom_version"))
}
...
tasks {
    val javaVersion = JavaVersion.toVersion(project.extra["java_version"]!!)
